...
// find the average pv by using map state
public class Example8 {
    public static void main(String[] args) throws Exception {
        ...
        env
                ...
                .keyBy(r -> 1)
                .process(
                        new KeyedProcessFunction<Integer, Event, String>() {
                            ...
                            public void open(Configuration parameters) throws Exception {
                                ...
                                mapState = getRuntimeContext().getMapState(
                                        new MapStateDescriptor<String, Long>("map-state", Types.STRING,Types.LONG)
                                );
                            }
                            @Override
